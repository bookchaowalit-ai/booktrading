...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    refreshPortfolio().finally(() => setIsLoading(false));
  }, [refreshPortfolio]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => { setIsLoading(true); refreshPortfolio().finally(() => setIsLoading(false)); }}
          className="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
        >
      ...
      {!portfolio || portfolio.length === 0 ? (
        <EmptyState
          ...
          title={t('portfolio.empty-title') || 'No Assets Yet'}
          description={t('portfolio.empty-description') || 'Start trading to see your portfolio here'}
        />
      ) : (
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-xs text-gray-600 dark:text-gray-400">{t('portfolio.total-pnl') || 'Total P&L'}</span>
              </div>
